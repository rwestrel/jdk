...
const Type::TYPES Type::dual_type[Type::lastype] = {
  ...
  Bad,          // InstKlassPtr - handled in v-call
  Bad,          // AryKlassPtr - handled in v-call
...
TypePtr::MeetResult TypePtr::meet_instptr(PTR &ptr, ciKlass* this_klass, ciKlass* tinst_klass, bool this_xk, bool tinst_xk,
                                          PTR this_ptr,
                                          PTR tinst_ptr, ciKlass*&res_klass, bool &res_xk) {// Found an InstPtr sub-type vs self-InstPtr type
...
TypePtr::MeetResult TypePtr::meet_aryptr(PTR& ptr, const Type*& elem, ciKlass* this_klass, ciKlass* tap_klass, bool this_xk, bool tap_xk, PTR this_ptr, PTR tap_ptr, ciKlass*& res_klass, bool& res_xk) {
  ...
  if (elem->isa_int()) {
    ...
    if ((above_centerline(ptr) || ptr == Constant) && this_klass != tap_klass &&
      ...
      res_xk = false;
      return NOT_SUBTYPE;
      //return make(NotNull, NULL, tary, res_klass, false, off, InstanceBot, speculative, depth);
    }
  ...
  switch (tap_ptr) {
    ...
    case TopPTR:
      ...
      return result;
      //      return make(ptr, const_oop(), tary, res_klass, xk, off, instance_id, speculative, depth);
    case Constant: {
//      ciObject* o = const_oop();
...
//        o = tap->const_oop();
      ...
      return result;
      //return TypeAryPtr::make(ptr, o, tary, res_klass, xk, off, instance_id, speculative, depth);
    }
    case NotNull:
    case BotPTR:
      // Compute new klass on demand, do not use tap->_klass
