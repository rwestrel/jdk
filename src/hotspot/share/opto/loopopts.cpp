...
//  if (n->Opcode() == Op_GetFromSVCache && n->in(0) == nullptr) {
...
//    Node* cache_cmp = cache_cmp->find_out_with(Op_CmpP);
//    assert(cache_cmp != nullptr, "");
//    Node* cache_bol = cache_cmp->unique_out();
//    assert(cache_bol->is_Bool(), "");
//    Node* cache_if = cache_bol->unique_out();
//    assert(cache_if->is_If(), "");
//
//    assert(first_key != nullptr, "");
//    Node* first_key_cmp = first_key->find_out_with(Op_CmpP);
//    assert(first_key_cmp != nullptr, "");
//
//    Node* second_key_cmp = nullptr;
//    if (second_key != nullptr) {
//      second_key_cmp = second_key->find_out_with(Op_CmpP);
//    }
//
//
//  }
