...
class Dependencies: public ResourceObj {
 ...
 public:
  ...
  static Klass* check_evol_method(Method* m, ProfileContext profile_context);
  ...
  DepType validate_dependencies(CompileTask* task, ProfileContext profile_context, char** failure_detail = nullptr);
 ...
 public:
  ...
  private:
    ...
    Klass* check_klass_dependency(KlassDepChange* changes, ProfileContext profile_context);
    Klass* check_new_klass_dependency(NewKlassDepChange* changes, ProfileContext profile_context);
  ...
  public:
    ...
    Klass* check_dependency(ProfileContext profile_context) {
    ...
    Klass* spot_check_dependency_at(DepChange &changes, ProfileContext profile_context);
