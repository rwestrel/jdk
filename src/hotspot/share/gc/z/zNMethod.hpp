...
private:
  static void attach_gc_data(CompiledMethod* nm);

  static void log_register(CompiledMethod* nm);
...
public:
  ...
  static void nmethod_oops_barrier(CompiledMethod* nm);

  static void nmethods_do_begin();
  static void nmethods_do_end();
  static void nmethods_do(NMethodClosure* cl);

  static ZReentrantLock* lock_for_nmethod(CompiledMethod* nm);
