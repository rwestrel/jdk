...
/**
 * @test
 * @run main/othervm -Xcomp -XX:CompileOnly=TestDeadPathManyDeadDataNodes::test1 -XX:CompileCommand=quiet -XX:CompileCommand=inline,TestDeadPathManyDeadDataNodes::inlined1 -XX:MaxRecursiveInlineLevel=1000 -XX:MaxInlineLevel=1000 -XX:-TieredCompilation -XX:+AlwaysIncrementalInline -XX:+DelayAfterInliningCutoff -XX:+IncrementalInlineForceCleanup  -XX:NodeCountInliningCutoff=100000 -XX:-RenumberLiveNodes -XX:+StressIGVN -XX:RepeatCompilation=100 -XX:-UseNewCode ${test.main.class}
 * @run main/othervm -Xcomp -XX:CompileOnly=TestDeadPathManyDeadDataNodes::test1 -XX:CompileCommand=quiet -XX:CompileCommand=inline,TestDeadPathManyDeadDataNodes::inlined1 -XX:MaxRecursiveInlineLevel=1000 -XX:MaxInlineLevel=1000 -XX:-TieredCompilation -XX:+AlwaysIncrementalInline -XX:+DelayAfterInliningCutoff -XX:+IncrementalInlineForceCleanup  -XX:NodeCountInliningCutoff=100000 -XX:-RenumberLiveNodes -XX:+StressIGVN -XX:RepeatCompilation=100 -XX:+UseNewCode ${test.main.class}
 */
